...
namespace ConsoleApp1
{
    public class SavingsAccount : BankAccount // Arv från BankAccount
    {
        ...
        public override void PrintAccountInfo() // overridear basklassens PrintAccountInfo för att lägga till räntan i utskriften
        {
            Console.WriteLine(
                $"Account: {AccountNumber}, Balance: {GetBalance()}, Interest Rate: {InterestRate * 100}%"
                ); 
        }
